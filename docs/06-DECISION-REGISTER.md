...
| `DEC-HG-004` | Employee identity linkage ve number reuse | `DEFERRED_WITH_HARD_GATE` | OD-026, DM-B01, DM-B08, UF-O-02, UF-O-16, UF-O-17, Gate0-AUD-017 | Accounts/import matching; retention pilot öncesi | HR/iş sahibi + security/privacy | Number uniqueness/reuse ve Employee↔ApplicationUser ilişkisi accounts öncesi; kişisel veri/photo/audit retention pilot öncesi. Receiver snapshot her durumda korunur. |
...
| `DEC-OPEN-005` | Storekeeper operational permissions | `OPEN` | OD-009, AUTH-011, UF-O-09 | İlgili warehouse feature | İş sahibi | Confirmed receipt/issue yetkileri korunur; diğerleri uydurulmaz. |
...
| `OD-025` | `DEC-OPEN-019` |
| `OD-026`, `DM-B01`, `DM-B08`, `UF-O-02`, `UF-O-16`, `UF-O-17` | `DEC-HG-004`, `DEC-OPEN-021` |
