...
def test_managed_permission_set_is_exactly_twenty():
...
def test_manager_capability_ceiling_applies_to_location_permissions():
    actor, _ = make_manager(
        safe_permissions=("locations.view_location", "locations.add_location")
    )
    role = Group.objects.create(name="Location lower")
    set_role_permissions(
        actor=actor,
        role_id=role.pk,
        catalog_permissions=[
...
def test_location_permissions_round_trip_with_view_dependency():
    actor = make_superuser()
    role = Group.objects.create(name="Location enabled")
    labels = [
        "locations.view_location",
        "locations.add_location",
        "locations.change_location",
